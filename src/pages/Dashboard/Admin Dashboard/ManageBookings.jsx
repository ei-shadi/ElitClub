...
const ConfirmedBookings = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Manage Bookings - EliteClub</title>
      </Helmet>
      ...
      <div className="p-4">
        ...
        {filteredBookings.length === 0 ? (
          ...
          <>
            ...
            {/* Count */}
            <div className="mt-6 text-right text-lg lg:text-xl font-semibold text-white bg-black py-2 px-10 rounded-2xl w-fit mx-auto">
